...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={ Dr. Scratch, análisis de proyectos Scratch para medir el desarrollo del Pensamiento Computacional y mejorar las habilidades de programación},
...
\title{Dr. Scratch}
\subtitle{Análisis de proyectos Scratch para medir el desarrollo del Pensamiento Computacional y mejorar las habilidades de programación}
...
\begin{frame}
\frametitle{¿Por qué una herramienta como Dr. Scratch?}
\begin{figure}[t!]
\begin{center}
