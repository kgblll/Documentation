...
\hypersetup{
  ...
  pdfauthor={J. Moreno-León, Gregorio Robles, Marcos Román-González},
...
\author{J. Moreno-León, Gregorio Robles, Marcos Román-González}
...
{\tiny
(cc) 2016 J. Moreno-León, Gregorio Robles and Marcos Román-González\\
...
\begin{columns}[T]
  \begin{column}{0.8\textwidth}
    \begin{block}{Several aspects must be taken into account}
      \begin{itemize}
        \item Data from 2007-2012, old version of the Scratch website (see \href{http://web.archive.org/web/20080527194722/http://scratch.mit.edu/}{Internet archive})
        \item Since 2012, important modifications in the website to enhance users' social participation
