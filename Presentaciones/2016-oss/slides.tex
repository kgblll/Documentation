...
\begin{enumerate}
  ...
  \begin{itemize}
   \item Adatation of Dr. Scratch to measure computational thinking skills with the information of the dataset. (\footnotesize See \href{http://drscratch.org}{http://drscratch.org})
  \end{itemize}
