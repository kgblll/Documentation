...
%--------------------------------------------------------
\begin{frame}
\frametitle{Correlations between Dr. Scratch and classic software engineering complexity metrics (I)}
\begin{center}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Correlations between Dr. Scratch and classic software engineering complexity metrics (II)}
\begin{center}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Correlations between Dr. Scratch and classic software engineering complexity metrics (and III)}
\begin{center}
