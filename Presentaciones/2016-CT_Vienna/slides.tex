...
\begin{columns}[T]
    \begin{column}{1\textwidth}
	 ...
	 \item Moreno, J., Robles, G, \& Roman-Gonzalez, M. (2015). Dr. Scratch: Automatic Analysis of Scratch Projects to Assess and Foster Computational Thinking. \textit{RED. Revista de Educación a Distancia, 15}(46).
	 \item Moreno, J., Robles, G, \& Roman-Gonzalez, M. (2016). Comparing computational thinking development assessment scores with software complexity metrics. In \textit{IEEE Global Engineering Education Conference (EDUCON), 2016 IEEE (in press)}. IEEE.
       \end{itemize}
    \end{block}
    \end{column}
  \end{columns}
