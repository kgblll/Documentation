...
\begin{columns}[T]
    \begin{column}{1\textwidth}
     \begin{block}{Dr. Scratch references}
       \begin{itemize}
	 \item Scratch conference
	 \item WIPSCE
	 \item Moreno-León, J., Robles G., \& Román-González, M. (2015). Dr. Scratch: Automatic Analysis of Scratch Projects to Assess and Foster Computational Thinking. RED, Revista de Educación a Distancia. Número 46. 15 de Septiembre de 2015. Consultado el (dd/mm/aaaa) en http://www.um.es/ead/red/46
	 \item EDUCON 2016
       \end{itemize}
    \end{block}
    \end{column}
