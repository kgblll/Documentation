...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={Análisis de aplicaciones con Dr.Scratch},
  pdfauthor={Gregorio Robles, Jesús Moreno León},
...
\subtitle{}
\institute{grex@gsyc.urjc.es, jesus.moreno@programamos.es \\
GSyC/Libresoft, Universidad Rey Juan Carlos}
\author{Gregorio Robles, Jesús Moreno León}
\date{VII jornadas iTIC (\#iTIC15), Madrid, 29 de abril de 2015}
