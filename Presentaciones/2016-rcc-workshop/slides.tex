...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={Automatic Analysis of Scratch Projects},
...
\title{Automatic Analysis of Scratch Projects}
\subtitle{Assessing Computational Thinking Skills}
\institute{jesus.moreno@programamos.es, grex@gsyc.urjc.es \\
GSyC/Libresoft, Universidad Rey Juan Carlos}
\author{Jesús Moreno León, Gregorio Robles}
\date{RCC Harvard, Cambridge, MA -- June 23\textsuperscript{rd}, 2016}
...
{\tiny
(cc) 2016 Jesús Moreno León and Gregorio Robles\\
...
\section{Computational Thinking and Coding at Schools, RCC Harvard}
...
\begin{columns}[T]
    \begin{column}{1\textwidth}
     \begin{block}{Analysis of Scratch projects}
       \begin{itemize}
	 \item \texttt{Scrape}: visual representation of the blocks used (and those that are not used).
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\caption{Analysis of 100 randomly downloaded Scratch projects}
\label{table:results}
\end{table}
\end{frame}
...
\begin{frame}
\frametitle{Dr. Scratch vs Expert judgment}
\begin{center}
\begin{center}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Dr. Scratch vs Expert judgment (and II)}
\begin{center}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Dr. Scratch vs CT-test}
\begin{center}
\begin{center}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Feedback from learners (I)}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Feedback from learners (II)}
\begin{center}
...
\begin{itemize}
  \item Fundamental CT skills not assessed
    \begin{enumerate}
      \item Debugging
      \item Remixing
      \item Design
  ...
  \item Democratizing digital expression (Mitch Resnick's view) may become secondary.
\end{itemize}
    \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}
\frametitle{Future Work on Dr. Scratch}

\begin{enumerate}
  \item User accounts
  \item Teacher dashboard
  \item Organization dashboard
  \item Sharing (anonymized) assessment data for researchers
  \item Create a Dr* infrastructure to allow assessing other learning environments
\end{enumerate}
\vspace{\baselineskip}
\vspace{\baselineskip}
\vspace{.4cm}
...
\begin{columns}[T]
    \begin{column}{1\textwidth}
	 ...
	 \item Moreno-Le\'on, J., Robles, G, \& Roman-Gonz\'alez, M. (2016). Comparing computational thinking development assessment scores with software complexity metrics. In \textit{Global Engineering Education Conference (EDUCON), 2016 IEEE (in press)}. IEEE.
       \end{itemize}
    \end{block}
    \end{column}
  \end{columns}
...
\frametitle{Conclusions and Future}
  ...
  \begin{enumerate}
    \item Dr. Scratch is up and running!
    \item We have compared its assessment with other assessment methods
    \item Dr. Scratch is an evolving project
    \item We are storing lots of data from assessing projects that we hope to share soon
    \item We want to apply the same ideas to other environments: AppInventor, Pencilcode, Python...
  \end{enumerate}
